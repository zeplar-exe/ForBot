        ...
        for thread in new_threads:
            ...
            post_content = chat(
                ...
                messages=[
                    ...
                    {"role": "system", "content": f"Here are the previous posts in the thread: {'\n'.join([post.content for post in previous_posts])}"},
                    {"role": "user", "content": f"Generate the content to a post replying in the thread titled '{thread.title}'. Make sure your post content is engaging and relevant to the forum topic. Use forum-like language and tone, such as lack of capitalization, grammar, and punctuation, as well as general internet acronyms and references, so long as they fit your stated personality. DO NOT INCLUDE AN IRRELEVANT INTRODUCTORY SENTENCE."}
