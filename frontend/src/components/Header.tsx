      ...
      <div className="header-inner" style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:12}}>
          ...
          <>
            ...
            {showAdvance && (
              <div style={{display:'flex',alignItems:'center',gap:8,marginLeft:8}}>
                <input type="number" min={1} value={hours} onChange={e=>setHours(Number(e.target.value))} style={{width:80}} disabled={loading} />
        ...
        {simId && (
          <Link to={`/simulations/${simId}/users`} style={{marginLeft:8}}>
            <button disabled={loading || serverAdvancing}>
              Users
